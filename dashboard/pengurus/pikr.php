      ...
      <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="row">
                  <div class="col-12 col-md-8"><span><h6>Data PIK-R</h6> </span></div>
                  <div class="col-6 col-md-4">
                  </div>
                  <span>
                            <a href="tambah_pik.php " class="btn btn-success btn-sm">
                              Tambah
                            </a>
                    </span>
              </div>
                  ...
                  ?>
                    <tr>
                      ...
                      <a href="" class="btn btn-primary btn-sm">
                            ...
                            <a href="del_pikr.php?id=<?php echo $hasil['id_pikr']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin Mau Hapus?')">
                              Hapus
                            </a>
                      </td>
                    </tr>
